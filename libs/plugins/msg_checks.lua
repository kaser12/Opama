...
local auto_leave = 'AutoLeaveBot' 
  ...
  send_msg(msg.to.id, "_لا يمكنك اضافتي الى المجموعه 📛 🔨_", nil, "md") 
  leave_group(chat) 
      end 
   end 
end 
...
return 
   ...
   del_msg(chat, msg.id) 
    kick_user(user, chat) 
   del_msg(chat, msg.id) 
send_msg(chat, "__آلـــ؏ۤـہٰٰــضۜہٰٰـوِ ⋮❊ֆ🦊🥇__ "..user_name.." `[ "..user.." ]`\n _تم منع عمل تكرار في المجموعه وقد تم طردك 🎐〰_", nil, "md") 
