...
package.cpath = package.cpath..';.luarocks/lib/lua/5.2/?.so'
    bot_token = "Token" -- هنا تخلي التوكين مال بوتك --
   send_api = "https://api.telegram.org/bot"..bot_token
sudo_id = 60809019  -- هنا تخلي ايديك --
require('./bot/methods')
...
function create_config( )
  ...
  config = {
    ...
    sudo_users = {60809019},--Sudo users
    info_text = [[🌟| TH3BOSS V17 Foar More Information Subscribe

🌟| https://github.com/moody2020/TH3BOSS-API 
